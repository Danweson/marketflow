...
const config: Config = {
    ...
    theme: {
        ...
        colors: {
            ...
            purple: {
                DEFAULT: "#9B51E0",     // Violet principal
                dark: "#7A35C0",        // Plus foncé
                light: "#B071E6",       // Plus clair
                "light-2": "#C89AF0",   // Encore plus clair
                "light-3": "#DCC1F7",
                "light-4": "#EAD8FB",
                "light-5": "#F5EDFF",   // Très pâle
            },
            red: {
                DEFAULT: "#F23030",
                dark: "#E10E0E",
            ...
            teal: {
                DEFAULT: "#02AAA4",
                dark: "#06A09B",
                simple: "color-mix(in srgb, #02AAA4 15%, white)"
            },
            orange: {
                DEFAULT: "#F27430",
                dark: "#E1580E",
