  ...
  return (
    <div className="bg-white shadow-1 rounded-lg">
      ...
      >
        <label
          htmlFor="sizeM"
          className="cursor-pointer select-none flex items-center rounded-md bg-dark text-white hover:bg-dark hover:text-white"
        >
        ...
        <label
          htmlFor="sizeL"
          className="cursor-pointer select-none flex items-center rounded-md hover:bg-dark hover:text-white"
        >
          <div className="relative">
