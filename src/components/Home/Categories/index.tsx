...
import { categoriesWithIcons } from "./categoryData";
...
const Categories = () => {
  ...
  return (
    <section className="overflow-hidden pt-17.5 pt-57.5 sm:pt-45 lg:pt-30 xl:pt-51.5">
      <div className="max-w-[1200px] w-full mx-auto px-4 sm:px-8 xl:px-0 pb-15 border-b border-dark-5">
        <div className="swiper categories-carousel common-carousel">
          ...
          >
            {categoriesWithIcons.map((item, key) => (
              <SwiperSlide key={key}>
