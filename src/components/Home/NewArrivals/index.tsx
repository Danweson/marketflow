...
const NewArrival = () => {
  return (
    <section className="overflow-hidden pt-15 pb-5">
      <div className="max-w-[1200px] w-full mx-auto px-4 sm:px-8 xl:px-0 border-b border-dark-5 pb-15">
        {/* <!-- section title --> */}
        <div className="mb-7 flex items-center justify-between">
          ...
          <Link
            href="/products"
            className="inline-flex font-medium text-custom-sm py-2.5 px-7 rounded-md border-gray-3 border bg-yellow text-white ease-out duration-200 hover:bg-dark hover:text-white hover:border-transparent"
          >
            {/* View All */}
            Voir plus
          </Link>
