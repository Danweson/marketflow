...
const Header = () => {
  ...
  const categories = [
  { label: "Toutes les catégories", value: "0" },
  { label: "Agriculture & Produits agricoles", value: "agriculture" },
  { label: "Vêtements & Mode", value: "fashion" },
  { label: "Électronique & Informatique", value: "electronics" },
  { label: "Automobile & Moto", value: "automotive" },
  { label: "Beauté & Soins personnels", value: "beauty" },
  { label: "Maison & Décoration", value: "home" },
  { label: "Cadeaux, Artisanat & Jouets", value: "gifts" },
  { label: "Machines & Outils industriels", value: "industrial" },
  { label: "Matériaux bruts & Construction", value: "materials" },
  { label: "Produits chimiques", value: "chemicals" },
];

  return (
    <header
      className={`fixed left-0 top-0 w-full z-9999 bg-dark text-white transition-all ease-in-out duration-300 ${
        stickyMenu && "shadow"
      }`}
    >
        ...
        >
          ...
          <div className="xl:w-auto flex-col sm:flex-row w-full flex sm:justify-between sm:items-center gap-5 sm:gap-10">
            <Link className="flex-shrink-0" href="/">
              {/* <div className="flex items-center gap-0"> */}
                <Image
                    src="/images/logo/logo-market-flow-text.png"
                    alt="MarketFlow"
                    width={200}
                    height={200}
                />
                {/* <div className="text-white font-bold">MarketFlow </div> */}

              {/* </div> */}
              
            </Link>
            {/* <h1 className="text-white font-bold">Market Flow</h1> */}

            <div className="max-w-[475px] w-full text-white">
              <form>
                <div className="flex items-center">
                  <CustomSelect options={categories} />

                  <div className="relative max-w-[333px] sm:min-w-[320px] w-full">
                    {/* <!-- divider --> */}
                    ...
                    <input
                      ...
                      autoComplete="off"
                      className="custom-search w-full rounded-r-[5px] bg-gray-1 text-dark !border-l-0 border border-gray-3 py-2.5 pl-4 pr-10 outline-none ease-in duration-200"
                    />
          ...
          <div className="flex w-full lg:w-auto items-center gap-7.5">
            <div className="hidden xl:flex items-center gap-3.5">
              ...
              <div>
                <span className="block text-2xs text-white uppercase">
                  24/7 SUPPORT
                </span>
            ...
            <div className="flex w-full lg:w-auto justify-between items-center gap-5">
              <div className="flex items-center gap-5">
                ...
                >
                  <span className="inline-block relative">
                    ...
                    <span className="flex items-center justify-center font-medium text-2xs absolute -right-2 -top-2.5 bg-yellow w-4.5 h-4.5 rounded-full text-white">
                      {product.length}
                    </span>
                  </span>
              ...
              <button
                id="Toggle"
                aria-label="Toggler"
                className="xl:hidden block bg-white"
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-7.5 xl:px-0">
          <div className="flex items-center justify-between">
            ...
            >
              {/* <!-- Main Nav Start --> */}
              <nav>
                <ul className="flex xl:items-center flex-col xl:flex-row gap-5 xl:gap-6" style={{ color: navigationOpen ? 'black' : 'white' }}>
                  {menuData.map((menuItem, i) =>
                    menuItem.submenu ? (
                      ...
                      <li
                        key={i}
                        className="group relative before:w-0 before:h-[3px] before:bg-yellow before:absolute before:left-0 before:top-0 before:rounded-b-[3px] before:ease-out before:duration-200 hover:before:w-full "
                      >
                        <Link
                          href={menuItem.path}
                          className={`${navigationOpen ? 'hover:text-yellow text-dark' : 'hover:text-yellow text-white' } text-custom-sm font-medium flex ${
            ...
            <div className="hidden xl:block">
              <ul className="flex items-center gap-5.5">
                <li className="py-4">
                  <a
                    href="#"
                    className="flex items-center gap-1.5 font-medium text-custom-sm text-white hover:text-yellow"
                  >
                    <svg
                      className="fill-current"
                      width="16"
