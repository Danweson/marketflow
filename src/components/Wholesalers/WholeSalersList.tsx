...
import data from "./wholesalerData";
import WholeSalerItem from "./Wholesaler";
...
const WholeSalersList = () => {
  ...
  const options = [
    { label: "Plus récents", value: "0" },
    { label: "Best Sellers", value: "1" },
    { label: "Plus anciens", value: "2" },
  ];
  ...
  return (
    <>
      <Breadcrumb
        title={"Chercher tous les agents"}
          ...
          <div className="flex gap-7.5">
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="bg-white shadow-1 rounded-lg py-4 px-5">
                    <div className="flex items-center justify-between">
                      <p>Filtres:</p>
                      <button className="text-dark hover:text-yellow font-medium text-sm">
                        {/* Clean All */}
                        Réinitialiser tout
                      </button>
                    </div>
            ...
            <div className="xl:max-w-[870px] w-full">
              ...
              >
                ...
                {data.map((item, key) => (
                    productStyle === "grid" ?
                    <WholeSalerItem key={key} item={item} />
                    :
                    <WholeSalerListItem key={key} item={item} />
                ))}
              </div>
                ...
                <div className="bg-white shadow-1 rounded-md p-2">
                  <ul className="flex items-center">
                    ...
                    <li>
                      <a
                        href="#"
                        className="flex py-1.5 px-3.5 duration-200 rounded-[3px] bg-yellow text-white hover:text-white hover:bg-yellow"
                      >
                        1
                      </a>
                    </li>
                    ...
                    <li>
                      <a
                        href="#"
                        className="flex py-1.5 px-3.5 duration-200 rounded-[3px] hover:text-white hover:bg-yellow"
                      >
                        2
                      </a>
                    </li>
