          ...
          <div className="flex flex-col lg:flex-row gap-10">
            ...
            <div className="lg:max-w-[370px] w-full space-y-6">
              <div className="bg-white shadow-1 rounded-xl p-6 space-y-4">
                <h3 className="text-lg font-medium text-dark">Contact Supplier</h3>
              ...
              <div className="bg-white shadow-1 rounded-xl p-6">
                <h3 className="text-lg font-medium text-dark mb-4">Latest Products</h3>
                <p className="text-gray-600 text-sm">List products or categories here...</p>
              </div>
            </div>
