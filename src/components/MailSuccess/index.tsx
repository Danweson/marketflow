          ...
          <div className="bg-white rounded-xl shadow-1 px-4 py-10 sm:py-15 lg:py-20 xl:py-25">
            <div className="text-center">
              ...
              <p className="max-w-[491px] w-full mx-auto mb-7.5">
                ...
                Merci beaucoup pour votre message. Nous vérifions fréquemment les e-mails
                et nous ferons de notre mieux pour répondre à votre demande.
              </p>

              <Link
                href="/"
                className="inline-flex items-center gap-2 font-medium text-white bg-dark py-3 px-6 rounded-md ease-out duration-200 hover:bg-dark"
              >
                <svg
