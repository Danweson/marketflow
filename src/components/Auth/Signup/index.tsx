              ...
              <form>
                <div className="mb-5">
                  ...
                  <input
                    ...
                    className="rounded-lg border border-gray-3 bg-gray-1 placeholder:text-dark-5 w-full py-3 px-5 outline-none duration-200 focus:border-transparent focus:shadow-input focus:dark focus:dark"
                  />
                </div>
                ...
                <div className="mb-5.5">
                  <label htmlFor="re-type-password" className="block mb-2.5">
                    Confirmer votre Mot de passe <span className="text-red">*</span>
                  </label>
                ...
                <button
                  type="submit"
                  className="w-full flex justify-center font-medium text-white bg-dark py-3 px-6 rounded-lg ease-out duration-200 hover:bg-yellow mt-7.5"
                >
                  {/* Create Account */}
                  S'Inscrire
                </button>
                ...
                <p className="text-center mt-6">
                  ...
                  <Link
                    href="/signin"
                    className="text-dark ease-out duration-200 hover:text-yellow pl-2"
                  >
                    {/* Sign in Now */}
