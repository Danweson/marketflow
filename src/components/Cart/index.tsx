...
const Cart = () => {
  ...
  return (
    <>
      ...
      <section>
        <Breadcrumb title={"Panier"} pages={["Panier"]} />
      </section>
      ...
      {cartItems.length > 0 ? (
        <section className="overflow-hidden py-20 bg-gray-2">
          <div className="max-w-[1200px] w-full mx-auto px-4 sm:px-8 xl:px-0">
            <div className="flex flex-wrap items-center justify-between gap-5 mb-7.5">
              ...
              <button className="text-dark hover:text-red text-no-wrap inline-flex items-center gap-1">
                {/* Clear Shopping Cart */}
                <BiTrash size={15}/> Vider le panier
              </button>
            </div>
        ...
        <>
          <div className="text-center mt-8 mb-20">
            ...
            <Link
              href="/products"
              className="w-96 mx-auto flex justify-center font-medium text-white bg-yellow py-[13px] px-6 rounded-md ease-out duration-200 hover:bg-dark"
            >
              {/* Continue Shopping */}
              Continuer à acheter
            </Link>
